...
export default function Sidebar({ currentMandant, sidebarOpen, onSelectMandant, onClose }) {
  ...
  return (
    <aside className={`sidebar${sidebarOpen ? " open" : ""}`}
      style={{ width: 240, background: "#0b2e44", display: "flex", flexDirection: "column", padding: "24px 0", position: "fixed", top: 0, left: 0, height: "100vh", zIndex: 200, transition: "transform .25s ease" }}>
