/**
 * Hinterlegte Ergebnisse der simulierten KI-Analyse (für die Präsentation).
 *
 * Eine echte KI würde die Daten aus dem Scan lesen. Hier liegen sie für einen
 * vorher ausgesuchten Beleg fest bereit. Erkannt wird der Beleg am Text des
 * gescannten PDFs (Texterkennung des Scanners) – ein neuer Scan desselben
 * Bons wird also wiedererkannt, auch wenn Dateiname und Bild jedes Mal anders
 * sind. Andere Belege erkennt die Simulation bewusst nicht.
 *
 * merkmale: Textstellen, die auf dem Beleg stehen. Verglichen wird ohne
 * Leerzeichen, Satzzeichen und Groß-/Kleinschreibung, weil die Texterkennung
 * eines Scanners die Abstände selten exakt trifft. Es müssen nicht alle
 * gefunden werden (siehe mindestTreffer) – einzelne Lesefehler sind normal.
 */

export const KI_DEMO_BELEGE = [
  {
    ...
    merkmale: [
      ...
      "Kati Sommer",
      "Ernst-Reuter-Allee",
      "DE221908587",      // USt-IdNr. des Markts
      "85,24",            // Summe
      "31.07.2026",
      "718025",           // Trace-Nr.
      "261903",           // TSE-Transaktion
      "MIO MIO MATE",
      "LINSEN CHIPS",
    ],
    mindestTreffer: 4,
